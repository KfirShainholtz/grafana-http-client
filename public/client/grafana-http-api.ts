...
export default class GrafanaHTTPApi {
    ...
    constructor(baseURL?: string, authKey? :IApiBearerAuth, basicAuth?: IBasicAuth) { // todo: remove any, make default constructors
        ...
        // TODO: basic auth and authorization bearer colide. change to accept only a signle one/ toggle them each time we need a new approach.
